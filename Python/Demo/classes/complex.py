...
# ---------------
#
# AmigaPython 2.7 has a builtin complex type.  This file remains as a
# teaching example of a numeric class with operators.  Prefer the
# builtin for real code:  z = 3+4j
#
